    ...
    <>
      <TabContext value={value}>
        <AppBar position="static">
          <Tabs centered style={{backgroundColor:'#16A085'}} onChange={handleChange}>
        ...
        <TabPanel value="2">
          <Typography variant="h5" gutterBottom color="inherit" component="h5" align="center" className="titulo">Sobre-nós</Typography>
